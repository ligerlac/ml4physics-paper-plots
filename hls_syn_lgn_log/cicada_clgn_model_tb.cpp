...
ap_uint<252> *read_input_from_file(const char *filename, size_t n_events) {
    ...
    // allocate array of n_events ap_uint<252>
    ap_uint<252> *inputs = (ap_uint<252> *)malloc(n_events * sizeof(ap_uint<252>));
    if (!inputs) {
...
void apply_logic_net(ap_uint<252> *inp, ap_uint<12> *out, size_t len) {
...
void test_logic_gate_net() {
    ...
    ap_uint<252> *test_input = read_input_from_file("x_val.txt", n_events);
